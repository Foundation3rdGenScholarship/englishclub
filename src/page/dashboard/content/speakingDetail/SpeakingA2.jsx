...
import { useAllSpeakingA2QueryQuery } from "../../../../redux/features/skill/skillSlice";
...
export const SpeakingA2 = () => {
  const { data, isLoading, error } = useAllSpeakingA2QueryQuery();
