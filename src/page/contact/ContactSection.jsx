...
const ContactSection = () => {
  ...
  return (
    <div className="max-w-7xl w-full overflow-hidden px-14  sm:px-14 min-w-[200px] flex flex-col md:flex-row justify-center items-center gap-8 m-auto">
      {/* Left Image */}
      <div className="w-full flex justify-center md:w-1/2">
        <img
          src="img/contactpage-img/contact-us.svg"
          alt="Contact Us"
          // className="max-w-xl"
        />
      </div>
