              ...
              {({ isSubmitting, errors, touched }) => (
                <Form className="mt-4 text-des-2 leading-loose text-left">
                  ...
                  <Field
                    ...
                    className={`w-full text-des-3 p-3 border rounded-lg dark:bg-transparent  mt-1 bg-[#F6FBFE] placeholder-gray-400 dark:placeholder-gray-500 ${
                  ...
                  <Field
                    ...
                    className={`w-full text-des-3 p-3 border rounded-lg dark:bg-transparent bg-[#F6FBFE] mt-1 placeholder-gray-400 dark:placeholder-gray-500 ${
                  ...
                  <Field
                    ...
                    className={`w-full text-des-3 p-3 border rounded-lg bg-[#F6FBFE] dark:bg-transparent mt-1 placeholder-gray-400 dark:placeholder-gray-500 ${
