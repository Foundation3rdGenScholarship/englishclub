...
const Announcement = () => {
  ...
  return (
    <div
      className={`bg-primary-950 px-4 py-3 text-white sticky top-0 z-50 transition-transform duration-300 ${
    ...
    >
      <div className="max-w-7xl flex items-center m-auto">
        ...
        <button
          onClick={handleClose}
          aria-label="Close"
          className="shrink-0 rounded-lg bg-black/10 p-1 transition hover:bg-black/20 xl:mr-5"
        >
          <IoMdClose />
        </button>
      </div>
