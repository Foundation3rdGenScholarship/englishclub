...
const AmeesageYourAreLate = () => {
  return (
    <div>
      <div class=" flex items-center justify-center text-black rounded-xl">
        <div class="border-2 border-gray-700 rounded-xl shadow-lg w-full ">
          <div class="bg-gray-50 px-4 py-3 border-b rounded-xl">
            <div class="flex items-center">
              <img
                src="https://tochratana.netlify.app/assets/tochratana-CiarzoR3.jpg"
                alt=""
                className="w-12 h-12 rounded-full object-cover"
              />
              <div class="ml-3">
                <p class="font-medium">Friend</p>
                <p class="text-des-3 text-gray-500">Online</p>
              </div>
            </div>
          </div>
          ...
          <div class="p-4  flex flex-col space-y-3">
            <div class="flex flex-col max-w-xs">
              <div class="bg-gray-200 rounded-2xl rounded-tl-none px-4 py-2 text-des-3">
...
export default AmeesageYourAreLate;
